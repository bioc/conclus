...
`retrieveGenesInfo` is a method for gene information retrieval from open-source databases and websites of NCBI, MGI, and UniProt. It requires the `calculateClustersSimilarity` method to have been run on the object.
