...
(CLDNs) are a family of integral membrane proteins that are aberrantly 
expressed in diverse types of human cancers, including hepatocellular 
carcinomas (HCCs); The  monoamine oxidase (Maob) is found in abundance in 
...
Shvartsman *et al.* dataset above (cluster similarity heatmap), one can see that 
...
![updatedCellSim Updated cells similarity matrix with merged 1/2 
and 9/10.](figures/15_updatedCellSim.png)
...
![updatedCellHeatmap Updated cells heatmap with merged 1/2 and 
...
![updatedTSNE 5th tSNE solution colored by dbscan result showing the merged 
